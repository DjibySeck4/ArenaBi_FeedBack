<?php
/* Smarty version 3.1.30, created on 2020-05-18 23:33:30
  from "C:\xampp\htdocs\PHP\SamaneMVC\AreneBiFeelBack\src\view\pages\lutte\video\edit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ec2ff2a2e0664_16971667',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7f942ee98f428b287123f7071b22bb8ea9b6d2fc' => 
    array (
      0 => 'C:\\xampp\\htdocs\\PHP\\SamaneMVC\\AreneBiFeelBack\\src\\view\\pages\\lutte\\video\\edit.html',
      1 => 1589837604,
      2 => 'file',
    ),
  ),
...
function content_5ec2ff2a2e0664_16971667 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
?>
		...
		<div class="col-md-7 col-xs-7 col-md-offset-2 thumbnail" style="margin-top:70px; margin-left:350;">
			...
			<div class="panel-heading"><b>Modifier une video</b></div>
...
Video/add" method="POST" enctype="multipart/form-data">
						<div class="form-group">
                            ...
                            <input type="date" name="id" value="<?php echo $_smarty_tpl->tpl_vars['video']->value->getIdVideo();?>
" class="form-control" placeholder="La id de prise de la photo" id="id" required>
                            <span id="dateVideochute_valid"></span>
						</div> 
                        <div class="form-group">
                            <label for="date">Date de la vidéo</label>
                            <input type="date" name="date" value="<?php echo $_smarty_tpl->tpl_vars['video']->value->getDateVideo();?>
" class="form-control" placeholder="La date de prise de la photo" id="date" required>
                            <span id="datePhoto_chute_valid"></span>
						</div>       
						<div class="form-group">
                            <label for="lieu">Lieu</label>
                            <input type="text" name="lieu" value="<?php echo $_smarty_tpl->tpl_vars['video']->value->getLieuVideo();?>
" class="form-control" id="lieu" required>
                            <span id="typePhoto_valid"></span>
						</div>                 
                        <div class="form-group">
                            <label for="type">Type de la type</label>
                            <input type="text" name="type" value="<?php echo $_smarty_tpl->tpl_vars['video']->value->getTypeVideo();?>
" class="form-control" id="type" required>
                            <span id="typePhoto_valid"></span>
						</div>
						<div class="form-group">
                            <label for="tag">Tag</label>
                            <input type="text" name="tag" value="<?php echo $_smarty_tpl->tpl_vars['video']->value->getTag();?>
