 ...
 */
class Manager extends \Manager implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Manager' . "\0" . 'idManager', '' . "\0" . 'Manager' . "\0" . 'personne', '' . "\0" . 'Manager' . "\0" . 'lutteurs'];
        }
    ...
    public function getIdManager()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdManager();
        }
    ...
    public function getLutteurs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLutteurs', []);

        return parent::getLutteurs();
    }
    ...
    public function setLutteurs($lutteurs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLutteurs', [$lutteurs]);

        return parent::setLutteurs($lutteurs);
    }
