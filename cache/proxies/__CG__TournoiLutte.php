 ...
 */
class TournoiLutte extends \TournoiLutte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TournoiLutte' . "\0" . 'idTournoiLutte', '' . "\0" . 'TournoiLutte' . "\0" . 'nomTournoi', '' . "\0" . 'TournoiLutte' . "\0" . 'dateDebut', '' . "\0" . 'TournoiLutte' . "\0" . 'dateFin', '' . "\0" . 'TournoiLutte' . "\0" . 'promoteur', '' . "\0" . 'TournoiLutte' . "\0" . 'combats', '' . "\0" . 'TournoiLutte' . "\0" . 'participants'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TournoiLutte $proxy) {
    ...
    public function getIdTournoiLutte()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdTournoiLutte();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTournoiLutte', []);

        return parent::getIdTournoiLutte();
    }
    ...
    public function setIdTournoiLutte($idTournoiLutte)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdTournoiLutte', [$idTournoiLutte]);

        return parent::setIdTournoiLutte($idTournoiLutte);
    }
    ...
    public function getNomTournoi()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomTournoi', []);

        return parent::getNomTournoi();
    }
    ...
    public function setNomTournoi($nomTournoi)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomTournoi', [$nomTournoi]);

        return parent::setNomTournoi($nomTournoi);
    }
