...
function content_5ec03733c02e36_71908304 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html>
	<head>
		<meta charset="UTF-8">
...
?>
						...
						<div class="form-row">
							...
							<div class="col-xs-4">
								...
								<select id="manager" name="manager" class="form-control custum-select" required>
...
?>
										<option value="<?php echo $_smarty_tpl->tpl_vars['manager']->value->getIdManager();?>
"><?php echo $_smarty_tpl->tpl_vars['manager']->value->getPersonne()->getPrenom();?>
