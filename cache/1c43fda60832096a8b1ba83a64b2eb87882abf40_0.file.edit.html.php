<?php
/* Smarty version 3.1.30, created on 2020-05-18 22:58:06
  from "C:\xampp\htdocs\PHP\SamaneMVC\AreneBiFeelBack\src\view\pages\lutte\photo\edit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ec2f6de5e3fb6_05425066',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1c43fda60832096a8b1ba83a64b2eb87882abf40' => 
    array (
      0 => 'C:\\xampp\\htdocs\\PHP\\SamaneMVC\\AreneBiFeelBack\\src\\view\\pages\\lutte\\photo\\edit.html',
      1 => 1589835395,
      2 => 'file',
    ),
  ),
...
function content_5ec2f6de5e3fb6_05425066 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
Photo/update" method="POST" enctype="multipart/form-data">
						<div class="form-group">
                            <label for="id">Identifiant</label>
                            <input type="text" name="id" readonly value="<?php echo $_smarty_tpl->tpl_vars['photo']->value->getIdPhoto();?>
" class="form-control" id="id" autofocus required>
                            <span id="idPhoto_valid"></span>
                        </div>
						<div class="form-group">
                            <label for="dossier">Dossier photo</label>
                            <input type="text" name="dossier" value="<?php echo $_smarty_tpl->tpl_vars['photo']->value->getDossierPhoto();?>
" class="form-control" placeholder="Lien du dossier" id="dossier" autofocus required>
                            <span id="dossierPhoto_valid"></span>
                        </div>
                        <div class="form-group">
                            <label for="date">Date de la photo</label>
                            <input type="date" name="date" value="<?php echo $_smarty_tpl->tpl_vars['photo']->value->getDatePhoto();?>
" class="form-control" placeholder="La date de prise de la photo" id="date" required>
                            <span id="datePhoto_chute_valid"></span>
                        </div>                        
                        <div class="form-group">
                            <label for="type">Type de la type</label>
                            <input type="text" name="type" value="<?php echo $_smarty_tpl->tpl_vars['photo']->value->getTypePhoto();?>
" class="form-control" id="type" required>
                            <span id="typePhoto_valid"></span>
						</div>
						<div class="form-group">
                            <label for="lieu">Lieu</label>
                            <input type="text" name="lieu" value="<?php echo $_smarty_tpl->tpl_vars['photo']->value->getLieuPhoto();?>
" class="form-control" id="lieu" required>
                            <span id="typePhoto_valid"></span>
						</div>
						<div class="form-group">
                            <label for="tag">Tag</label>
                            <input type="text" name="tag" value="<?php echo $_smarty_tpl->tpl_vars['photo']->value->getTag();?>
" class="form-control" id="tag" required>
                            <span id="tagPhoto_valid"></span>
						</div>
						<div class="form-group">
							<label for="description">Description</label>
							<textarea name="description" id="description" cols="30" rows="3" class="form-control" required><?php echo $_smarty_tpl->tpl_vars['photo']->value->getDescription();?>
</textarea>
